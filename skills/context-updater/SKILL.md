...
section you do not own will be rejected by the hook. `gaia` and
`speckit-planner` do not write to project-context -- they manage gaia-ops
internals and specs respectively.
