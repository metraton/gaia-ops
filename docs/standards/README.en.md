...
| `command-execution.md` | ~130 | Execution pillars, path handling | On-demand |
| `anti-patterns.md` | ~190 | Common mistakes by tool | On-demand |
...
3. Add to `ALWAYS_PRELOAD_STANDARDS` or `ON_DEMAND_STANDARDS`
4. Choose triggers wisely - too broad = wasted tokens

## Maintenance

When updating agent prompts, extract duplicated content here:

1. Identify repeated sections across 2+ agents
2. Extract to a new standard file
3. Update agents to reference standards
