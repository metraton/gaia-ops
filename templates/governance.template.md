...
> Generated by gaia-init from project-context.json.
> Stack Definition is auto-updated via GOVERNANCE_UPDATE when new specs are created.
> Architectural Principles are immutable — change only via ADR.
...
- **Terraform Base Path**: [TERRAFORM_PATH]

### Kubernetes Layer
- **Orchestration**: [K8S_PLATFORM]
- **Cluster**: [CLUSTER_NAME]
- **GitOps Tool**: Flux CD
- **GitOps Repository**: [GITOPS_PATH]
...
**ADR Template**: `<speckit-root>/decisions/adr-template.md`

**ADR Location**: `<speckit-root>/decisions/`
...
**Last Updated**: [DATE] | **Generated from**: project-context.json
